...
CREATE TABLE `job` (
  ...
  CONSTRAINT `job_ibfk_10` FOREIGN KEY (`customerId`) REFERENCES `customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `job_ibfk_9` FOREIGN KEY (`customerId`) REFERENCES `customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'admin','$2b$10$4/mXde0K6Qd6c3ytjx1D4OI9g.vq.SEMBia/W0Jp.k3.52HNi9BO6','admin',1,'2025-02-21 18:42:46','2025-02-21 18:43:48',NULL),(2,'sesalefe','$2b$10$9araLHfJl2kHUliJ/wupRePypmJ9.MWL5hYiWw6Ea/rRnidd3KQni','employee',1,'2025-02-21 18:44:23','2025-02-21 18:44:23',NULL);
...
-- Dump completed on 2025-02-21 21:45:30
